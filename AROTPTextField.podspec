#
#  Be sure to run `pod spec lint AROTPTextField.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/manii9894/AROTPTextField"
  ...
  spec.source       = { :git => "https://github.com/manii9894/AROTPTextField.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "AROTPTextField"
